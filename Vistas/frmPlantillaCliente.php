...
<body>
  <header>
    <nav>
      ...
      <ul class="menu">
      <li><a href="/Mix-Sand?C=MostrarMenu&M=IniciarInicioU">Inicio</a></li>
        <li><a href="/Mix-Sand?C=MostrarMenu&M=ProductosC">Crear</a></li>
        <li><a href="/Mix-Sand?C=login&M=cerrarsesion">Cerrar Sesion</a>
        </li>
      </ul>
    </nav>
  </header>
